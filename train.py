...
def train(hyp, opt, device, tb_writer=None):
    ...
    is_coco = opt.data.endswith('bdd.yaml')
    ...
    if rank in [-1, 0]:
        ...
        if opt.data.endswith('bdd.yaml') and nc == 7:  # if COCO
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/bdd.yaml', help='data.yaml path')
    parser.add_argument('--hyp', type=str, default='data/hyp.scratch.yaml', help='hyperparameters path')
    parser.add_argument('--epochs', type=int, default=1)
    parser.add_argument('--batch-size', type=int, default=17, help='total batch size for all GPUs')
